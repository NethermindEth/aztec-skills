...
Installs core account-related Aztec packages into the current project.
...
packages=(
  ...
  "@aztec/entrypoints${suffix}"
  "@aztec/key-store${suffix}"
  "@aztec/wallets${suffix}"
)
